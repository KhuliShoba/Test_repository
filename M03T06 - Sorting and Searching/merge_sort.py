...
# Merge two sections of a list based on the length of the strings 
...
#create three lists of strings with 10 string elements each and sort them by length in descending order using the merge_sort_by_length function
list_1 = ["apple", "banana", "mango", "orange", "pineapple", "fig", "grape", "strawberry", "kiwi", "watermelon"]   
list_2 = ["aligattor", "panda", "elephant", "giraffe", "hippopotamus", "armadillo", "jaguar", "kangaroo", "lion", "squid"]        
list_3 = ["red", "burgundy", "green", "yellow", "indigo", "orange", "amaranth pink", "charcoal", "black", "white"]      
#print the original lists
print("Original list 1:", list_1)
print("Original list 2:", list_2)
print("Original list 3:", list_3)
...
print("Sorted list 3:", sorted_list_3)
